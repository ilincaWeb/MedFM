...
<div id="sidebar">
  ...
  <div class="container container-home web">
    <h2>Educație pentru sănătate la doua click-uri!</h2>
    <p>Alegerea cea mai bună este aceea de a dedica timp <b>educației pentru sănătate</b> deoarece îți oferă cunoștințele necesare pentru a preveni boli,
      a recunoaște simptomele timpurii și a lua decizii informate cu privire la tratamente. Aceasta contribuie la o viață mai lungă și mai sănătoasă,
        reducând riscul de complicații medicale și costuri asociate tratamentelor pe termen lung. </p>
    <br>
    <p><b><span style="color: #618264">MedFM</span></b> implementeză această idee, oferind <b>accesul gratis și direct la webminariile organizate</b> pentru pacienții cabinetelor de medicină de familie care folosesc aplicația noastră 
      și prin crearea de <b>videoclipuri explicative pe YouTube</b>, realizate de echipa MedFM.</p>
      <div class="cards-container">
    <a href="web_zoom.php"><button class="card card-web">Participa la Webminarul lunar</button></a>
    <a href="https://www.youtube.com/@MedFM-o7c" target="_blank"><button class="card card-web">MedFM - YouTube page</button></a>
    </div>
  </div>
